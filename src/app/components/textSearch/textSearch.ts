...
class TextSearch extends WFMComponent {
    constructor(config: ComponentConfig) {
        super(config);
    }
}

export const textSearch = new TextSearch({
    selector: 'text-search',
    innerComponents: null,
    getTemplate: () => `
            <div class="text-search input-group">
              <input type="text" class="text-search__input form-control" placeholder="Start typing to search" aria-label="Username" aria-describedby="text-search">
              <span class="text-search__icon input-group-text" id="text-search">
